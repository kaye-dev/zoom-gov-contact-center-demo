...
export type ZaadAuditInput = {
  ...
  resourceKind: "purpose-campaign" | "default-group" | "registration-membership" | "caller-notice" | "municipal-registration" | "municipal-workflow" | "municipal-run" | "municipal-case" | "outreach-contact" | "crm-import" | "campaign-binding" | "resource-binding" | "university-registration" | "university-outreach" | "university-case" | "university-intake" | "resident" | "message" | "contact-list" | "registration-setting" | "campaign" | "one-time-dispatch";
  targetId: string;
  action: string;
