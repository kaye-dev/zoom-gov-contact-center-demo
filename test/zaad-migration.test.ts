...
test("ZMI-02: 適用済みZAAD migrationのSQLとmanifest hashを維持する", () => {
  ...
  assert.equal(
    ...
    manifest.migrations.length - 18,
  );
  assert.deepEqual(
    manifest.migrations.slice(-17).map(({ name }) => name),
    [
      ...
      "20260907070000_add_online_consultation_memo",
      "20260908060000_university_outreach",
      "20260908063000_university_outreach_action_receipts",
      "20260909050000_outreach_crm_municipal",
      "20260909070000_outreach_registration_reception",
      "20260909130000_shared_contact_list_bindings",
      "20260910080000_global_api_default_groups",
      "20260910140000_outreach_purpose_campaigns",
      "20260911010000_outreach_imported_audio_messages",
      "20260911050000_outreach_tenant_scope",
      "20260911051000_outreach_message_content",
      "20260912090000_add_site_access_control",
    ],
  );
