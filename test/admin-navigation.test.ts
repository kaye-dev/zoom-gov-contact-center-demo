...
test("outreach sidebar chooses only an authorized tenant including an explicit cross-tenant selection", () => {
  ...
  assert.equal(href(["univ"], "lg", null), "/admin/zaad?tenant=univ");
  assert.equal(href(["univ"], "univ", "lg"), "/admin/zaad");
