...
export function OutreachMessages(props: OutreachPanelProps) {
  ...
  return <div className="space-y-5"><div className="flex flex-wrap items-center justify-between gap-3"><h2 ref={heading} tabIndex={-1} className="text-lg font-bold">{d.tabs[4]}</h2>{permissions.create && <button className={primary} disabled={busy} onClick={() => edit()}>{z.common.create}</button>}</div>
