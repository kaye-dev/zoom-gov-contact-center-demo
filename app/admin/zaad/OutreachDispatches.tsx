...
export function OutreachDispatches(props: OutreachPanelProps) {
  ...
  return <div className="space-y-5"><div className="flex flex-wrap items-center justify-between gap-3"><h2 className="text-lg font-bold">{d.tabs[3]}</h2>{permissions.create && <button className={primary} onClick={() => go("dispatch-create")}>{z.common.create}</button>}</div>
