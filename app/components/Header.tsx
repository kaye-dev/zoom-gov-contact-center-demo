...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex h-20 items-stretch border-t-4 border-b border-t-primary border-b-gray-200 bg-white text-gray-800 transition-all dark:border-b-gray-700 dark:bg-gray-900 dark:text-gray-100">
      {/* ロゴ */}
      {logo}
