  ...
  ja: {
    ...
    admin: {
      ...
      accessControl: {
        ...
        adminPageAccessDescription: '各アクションを未設定、許可、拒否から設定します。明示的な拒否は許可より優先されます。',
  ...
  en: {
    ...
    admin: {
      ...
      accessControl: {
        ...
        adminPageAccessDescription: 'Set each action to not set, allow, or deny. An explicit deny overrides an allow.',
  ...
  'zh-Hans': {
    ...
    admin: {
      ...
      accessControl: {
        ...
        adminPageAccessDescription: '将各项操作设置为未设置、允许或拒绝。明确拒绝优先于允许。',
  ...
  'zh-Hant': {
    ...
    admin: {
      ...
      accessControl: {
        ...
        adminPageAccessDescription: '將各項動作設定為未設定、允許或拒絕。明確拒絕優先於允許。',
  ...
  ko: {
    ...
    admin: {
      ...
      accessControl: {
        ...
        adminPageAccessDescription: '각 작업을 미설정, 허용 또는 거부로 설정합니다. 명시적 거부가 허용보다 우선합니다.',
