...
const editKeys=["help","replace","bodyHelp","effect","save","saved","unlink","unlinkHelp","unlinked","source","restricted"] as const;
const editRows:Record<Locale,string[]>={
ja:["保存するとZoom Contact Centerの音声アイテムを更新します。","読み上げ本文・音声を変更する","本文を取得できた場合は初期入力しています。本文未取得の場合は、新しい全文を入力してください。","この音声を使用するZoom側のフローにも変更が反映されます。","Zoomに保存","Zoomのメッセージを更新しました。","取り込みを解除","サイトの一覧から削除します。Zoom側の音声と過去の履歴は残ります。同期から再び取り込めます。","取り込みを解除しました。Zoom側の音声は残っています。","サイトで入力した本文（Zoomから取得した本文ではありません）","この音声は本文を必要とする配信には使用できません。"],
en:["Saving updates the audio item in Zoom Contact Center.","Change speech text and voice","Retrieved text is prefilled. If text is unavailable, enter the full replacement.","Changes also affect Zoom flows using this audio.","Save to Zoom","Updated the Zoom message.","Remove import","Remove from this site. Zoom audio and historical records remain. You can import it again.","Import removed. Audio remains in Zoom.","Text entered on this site (not retrieved from Zoom)","This audio cannot be used for delivery requiring text."],
"zh-Hans":["保存将更新Zoom Contact Center中的音频项目。","更改朗读文本和语音","已获取的文本会预填。未获取文本时，请输入完整的新文本。","更改也会影响使用此音频的Zoom流程。","保存到Zoom","已更新Zoom消息。","解除导入","从本站列表移除。Zoom音频和历史记录会保留，可再次导入。","已解除导入，Zoom音频已保留。","在本站输入的文本（并非从Zoom获取）","此音频不能用于需要文本的发送。"],
"zh-Hant":["儲存將更新Zoom Contact Center中的音訊項目。","變更朗讀文字和語音","已取得的文字會預填。未取得文字時，請輸入完整的新文字。","變更也會影響使用此音訊的Zoom流程。","儲存至Zoom","已更新Zoom訊息。","解除匯入","從本站清單移除。Zoom音訊和歷史紀錄會保留，可再次匯入。","已解除匯入，Zoom音訊已保留。","在本站輸入的文字（並非從Zoom取得）","此音訊不能用於需要文字的傳送。"],
ko:["저장하면 Zoom Contact Center의 오디오 항목이 업데이트됩니다.","읽기 텍스트 및 음성 변경","가져온 텍스트는 미리 입력됩니다. 텍스트가 없으면 전체 내용을 입력하세요.","이 오디오를 사용하는 Zoom 흐름에도 변경 사항이 반영됩니다.","Zoom에 저장","Zoom 메시지를 업데이트했습니다.","가져오기 해제","이 사이트 목록에서 삭제합니다. Zoom 오디오와 과거 기록은 유지되며 다시 가져올 수 있습니다.","가져오기를 해제했습니다. Zoom 오디오는 유지됩니다.","이 사이트에서 입력한 텍스트 (Zoom에서 가져온 텍스트가 아님)","이 오디오는 텍스트가 필요한 발신에 사용할 수 없습니다."]};
...
export const audioPlaybackDictionaries:Record<Locale,{load:string;loading:string;failed:string;retry:string;unknown:string;label:string;source:string}>={
ja:{load:"音声を読み込む",loading:"音声を取得中…",failed:"音声を取得できませんでした。",retry:"再試行",unknown:"本文の取得状況は未確認です。",label:"音声の再生・一時停止",source:"Zoomから取得した本文"},
en:{load:"Load audio",loading:"Loading audio…",failed:"Unable to load audio.",retry:"Retry",unknown:"Text availability is unverified.",label:"Play or pause audio",source:"Text retrieved from Zoom"},
"zh-Hans":{load:"加载音频",loading:"正在加载音频…",failed:"无法加载音频。",retry:"重试",unknown:"文本获取情况尚未确认。",label:"播放或暂停音频",source:"从Zoom获取的文本"},
"zh-Hant":{load:"載入音訊",loading:"正在載入音訊…",failed:"無法載入音訊。",retry:"重試",unknown:"文字取得情況尚未確認。",label:"播放或暫停音訊",source:"從Zoom取得的文字"},
ko:{load:"오디오 불러오기",loading:"오디오 불러오는 중…",failed:"오디오를 불러오지 못했습니다.",retry:"다시 시도",unknown:"텍스트 제공 여부를 확인하지 못했습니다.",label:"오디오 재생 및 일시정지",source:"Zoom에서 가져온 텍스트"}};
