...
- UI validations reuse representative smoke comparisons under [workflow-verification-contract.md](../../plan/references/workflow-verification-contract.md): prototype structure/appearance, major visual breakage and main happy paths. Include comparison conditions, observed matches, accepted direct-instruction differences, and unverified comparisons. Separate failures from unavailable Browser and unchecked human review. Detailed-parity records are historical inputs only and are not required validations.
