...
- Independently classify UI impact. Evaluate the goal, prototype intent, latest direct minor-UI instructions, focused checks, and representative smoke results under [workflow-verification-contract.md](../plan/references/workflow-verification-contract.md).
