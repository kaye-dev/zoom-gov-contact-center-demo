...
- Independently classify UI impact. Evaluate the goal, actual prototype design, latest direct minor-UI instructions, focused checks, and representative smoke comparisons under [workflow-verification-contract.md](../plan/references/workflow-verification-contract.md). Check the reported conditions, matches, accepted differences, and any unverified comparison; usability alone does not prove prototype conformance.
